            ...
            <ul class="pagination justify-content-center">
                ...
                @for ($i = $start; $i <= $end; $i++)
                    <li class="page-item {{ ($i == $paginator->currentPage()) ? 'active' : '' }}">
                        <a class="page-link" href="{{ $paginator->appends(request()->query())->url($i) }}" @if($i == $paginator->currentPage()) style="background-color: black !important; border-color: black !important;" @endif>{{ $i }}</a>
                    </li>
                @endfor
